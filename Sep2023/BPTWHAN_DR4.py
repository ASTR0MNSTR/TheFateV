...
class Main:
    ...
    def plotting_BPT(self):
        self.gs_top = plt.GridSpec(2, 2, wspace=0, hspace=0)
        self.fig = plt.figure(figsize=(12, 12), tight_layout=True)
        # self.fig = plt.figure(figsize=(13, 12))
        # adjusting_figure_size(14, 12, l=1.2, r=1.8, b=0.6, t=0.3)
    ...
    def plotting_WHAN(self):
        ...
        self.fig.savefig('./FIGURES_IN_PAPER_DR4/BPT_WHAN_only.png', dpi=1000, transparent = False, bbox_inches = 'tight', pad_inches = 0.1)
